...
const userAdminRoutes = require('../modules/user/admin/adminUser.route');
const couponRoutes = require('../modules/coupon/coupon.routes');
const couponAdminRoutes = require('../modules/coupon/admin/coupon.admin.route');
...
const returnAdminRoutes = require('../modules/return/admin/returnAdmin.routes');
...
router.use('/admin/returns', returnAdminRoutes);
