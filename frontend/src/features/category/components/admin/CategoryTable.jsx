    ...
    <div className="w-full overflow-x-auto rounded-xl">
      <table className="w-full min-w-[900px]">
        <thead className="border-b bg-slate-50">
          <tr>
            <th className="px-4 py-3 text-left text-xs font-bold uppercase tracking-wider text-slate-500 sm:px-6 sm:py-4">
              Danh mục
            </th>
            ...
            <th className="px-4 py-3 text-center text-xs font-bold uppercase tracking-wider text-slate-500 sm:px-6 sm:py-4">
              Trạng thái
            </th>
          ...
          {treeData.map(category => {
            ...
            return (
              ...
              >
                ...
                >
                  <span className="rounded bg-slate-100 px-2 py-1 font-mono text-xs text-slate-600 whitespace-nowrap">
                    {category.slug}
                  </span>
                </td>
