...
const CheckoutSummary = ({ previewData, province, isCalculated, isSubmitting, handlePlaceOrder, formatPrice }) => {
  return (
    <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 space-y-3 text-xs">
      ...
      <div className="border-t border-gray-150 pt-3 flex justify-between items-center">
        ...
        <span className="text-xl font-black text-[#ee4d2d]">{formatPrice(previewData?.totalAmount)}</span>
      </div>
