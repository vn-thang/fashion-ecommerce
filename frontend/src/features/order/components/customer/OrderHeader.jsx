...
const OrderHeader = ({ order, statusConfig, formatDate }) => {
  ...
  return (
    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 border-b border-gray-100 pb-4 mb-4">
      <div>
        <h1 className="text-lg font-bold text-gray-800">Chi tiết đơn hàng</h1>
      ...
      <div className={`px-4 py-2 rounded-full font-bold text-xs ${currentStatus.color} ${currentStatus.bg}`}>
        {currentStatus.label}
      </div>
    </div>
  );
